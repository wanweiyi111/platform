function H5sPlayerWS(t) {
    this.sourceBuffer,
        ...
        this.W = t.videoid,
        this.C = t.token,
        void 0 === this.W ? (this.I = t.videodom,
            console.log(t.token, "use dom directly")) : (this.I = document.getElementById(this.W),
    ...
    this.i,
        ...
        void 0 === this.W ? (this.I = t.videodom,
            console.log(t.token, "use dom directly")) : (this.I = document.getElementById(this.W),
                console.log(t.token, "use videoid")),
        this.A = this.I,
        this.A.type = "application/x-mpegURL",
        this.T = 0,
        this.M = 0;
...
function float32ToInt16(t) {
    for (l = t.length,
        buf = new Int16Array(l); l--;)
        buf[l] = 32767 * Math.min(1, t[l]);
    return buf
}
H5sPlayerWS.prototype.G = function () {
    console.log("Try Reconnect...", this.v), !0 === this.v && (console.log("Reconnect..."),
        this._(this.C),
        this.v = !1),
    ...
    H5sPlayerWS.prototype.K = function (t) {
        ...
        try {
            "http:" == this.P.protocol && (s = "undefined" != typeof MozWebSocket ? new MozWebSocket("ws://" + this.P.host + t) : new WebSocket("ws://" + this.P.host + t)),
                "https:" == this.P.protocol && (console.log(this.P.host),
                    s = "undefined" != typeof MozWebSocket ? new MozWebSocket("wss://" + this.P.host + t) : new WebSocket("wss://" + this.P.host + t)),
    ...
    H5sPlayerWS.prototype.q = function (t) {
        if (!0 !== this.k)
            return !1 === this.p ? (this.H = String.fromCharCode.apply(null, new Uint8Array(t.data)),
                this.F(this),
                void (this.p = !0)) : (this.buffer.push(t.data),
                    void this.V())
    },
    H5sPlayerWS.prototype.F = function (t) {
        try {
            ...
            t.s.src = window.URL.createObjectURL(t.t),
                t.s.play(),
                t.t.addEventListener("sourceopen", t.X.bind(t), !1)
        } catch (t) {
            console.log(t)
        }
    },
    H5sPlayerWS.prototype.X = function () {
        console.log("Add SourceBuffer"),
            ...
            this.t.duration = 1 / 0,
            this.t.removeEventListener("sourceopen", this.X, !1),
        ...
        s = this.P.rootpath + s + "?token=" + t + "&session=" + this.P.session,
            ...
            this.i.onopen = function () {
                console.log("wsSocket.onopen", this.Y),
                    this.Y.o = setInterval(this.Y.Z.bind(this.Y), 1e4),
                    this.Y.h = setInterval(this.Y.j.bind(this.Y), 1e3)
            },
            this.i.onclose = function () {
                console.log("wsSocket.onclose", this.Y), !0 === this.Y.k ? console.log("wsSocket.onclose disconnect") : this.Y.v = !0,
                    this.Y.$(this.Y),
                    this.Y.tt(this.Y),
                    this.Y.H = "",
                    this.Y.p = !1
    ...
    H5sPlayerWS.prototype.Z = function () {
        !0 === this.k && (console.log("CheckSourceBuffer has been disconnect", this),
        ...
        try {
            if (console.log("CheckSourceBuffer", this),
                ...
                if (5 < s || s < 0)
                    return console.log("CheckSourceBuffer Close 2", s),
                        void this.i.close();
                if (t == this.u) {
                    if (this.S++,
                        3 < this.S)
    ...
    H5sPlayerHls.prototype._ = function (t) {
    ...
    H5sPlayerHls.prototype.et = function () {
        console.log("HLS video.ended", this.A.ended),
            console.log("HLS video.currentTime", this.A.currentTime);
        var t = this.A.currentTime,
            s = t - this.T;
        console.log("HLS diff", s),
            0 === s && this.M++,
            this.T = t,
            3 < this.M && (null != this.i && (this.i.close(),
                this.i = null),
                this._(this.C),
                ...
                this.T = 0,
                this.M = 0,
                this.A.src = this.P.protocol + "//" + this.P.host + this.P.rootpath + "hls/" + this.m + "/" + this.C + "/hls.m3u8",
                this.A.play())
    },
    ...
    H5sPlayerRTC.prototype.ct = function () {
        ...
        var s = new RTCPeerConnection(this.g, this.J),
            e = this;
        return s.onicecandidate = function (t) {
            e.it.call(e, t)
        },
            void 0 !== s.ht ? s.ht = function (t) {
                e.ot.call(e, t)
            } :
            ...
            console.log("Created RTCPeerConnnection with config: " + JSON.stringify(this.g) + "option:" + JSON.stringify(this.J)),
            s
    },
    ...
    H5sPlayerRTC.prototype.q = function (t) {
        ...
        console.log("Get Message type ", s.type),
            "offer" === s.type && (console.log("Process Message type ", s.type),
                this.rt(s)),
            "remoteice" === s.type && (console.log("Process Message type ", s.type),
                this.lt(s))
    },
    H5sPlayerRTC.prototype._ = function (t) {
        ...
        s = this.P.rootpath + s + "?token=" + t,
            ...
            this.i.onopen = function () {
                ...
                this.Y.i.send(JSON.stringify(t)),
                    this.Y.h = setInterval(this.Y.j.bind(this.Y), 1e3)
            },
            this.i.onclose = function () {
                console.log("wsSocket.onclose", this.Y), !0 === this.Y.k ? console.log("wsSocket.onclose disconnect") : this.Y.v = !0,
    ...
    H5sPlayerAudio.prototype.q = function (t) {
        for (var s = new Int16Array(t.data), e = s.length, i = this.D.createBuffer(1, e, 8e3), o = 0; o < 1; o++)
            for (var n = i.getChannelData(o), c = 0; c < e; c++)
                n[c] = s[c] / 16383.5;
        var h = this.D.createBufferSource();
        h.buffer = i,
            h.connect(this.D.destination),
            h.start()
    },
    ...
    H5sPlayerAudBack.prototype.dt = function (t) {
        try {
            ...
            s.connect(e),
                ...
                e.onaudioprocess = this.ft.bind(this)
        } catch (t) {
            return void alert("Audio intecomm error", t)
        }
    },
