<template>
  <section class="ctrl-light">
    <CtrlPanel :class="['bottom-sidebar', {high: showMoreLight}]" :splitLine="true">
      <dt slot="title" class="split-line">
        ...
        <div class="fr pd-x10">
          ...
          <a-input-search
            ...
            style="width: 130px;"
          />
          <a-button icon="delete" size="small" @click="deleteMutip">删除</a-button>
        </div>
      </dt>
      <dd slot="content" class="pd-x20">
        ...
        >
          <span slot="action" slot-scope="text, record">
            ...
            <router-link :to="'./linkage-edit?linkId=' + record.id" class="white1" title="修改">
        ...
        <a-modal
          ...
          cancelText='取消'
        >
          <RuleTable :ruleList="curRule.details" :type="type" :isEdit="false"></RuleTable>
        </a-modal>
      </dd>
    </CtrlPanel>
  </section>
